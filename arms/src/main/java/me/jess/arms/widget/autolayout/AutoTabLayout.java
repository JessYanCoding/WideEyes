package me.jess.arms.widget.autolayout;
...
public class AutoTabLayout extends TabLayout
{
    ...
    public AutoTabLayout(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, me.jess.arms.R.styleable.TabLayout,
                defStyleAttr, me.jess.arms.R.style.Widget_Design_TabLayout);
        int tabTextAppearance = a.getResourceId(me.jess.arms.R.styleable.TabLayout_tabTextAppearance,
                me.jess.arms.R.style.TextAppearance_Design_Tab);
    ...
    {
        TypedArray a = context.obtainStyledAttributes(attrs, me.jess.arms.R.styleable.AutoTabLayout);
        mTextSizeBaseWidth = a.getBoolean(me.jess.arms.R.styleable.AutoTabLayout_auto_textSize_base_width, false);
        a.recycle();
    }
    ...
    private int loadTextSizeFromTextAppearance(int textAppearanceResId)
    {
        TypedArray a = getContext().obtainStyledAttributes(textAppearanceResId,
                me.jess.arms.R.styleable.TextAppearance);

        try
        {
            if (!DimenUtils.isPxVal(a.peekValue(me.jess.arms.R.styleable.TextAppearance_android_textSize)))
                return NO_VALID;
            return a.getDimensionPixelSize(me.jess.arms.R.styleable.TextAppearance_android_textSize, NO_VALID);
        } finally
        {
            a.recycle();
        }
